...
import { fetchLaptopProducts } from "@/app/redux/slices/customerSlice";
import Product_card from "@/app/roles/customer_system/components/Product_card";

const Page = () => {
    const dispatch = useDispatch()
    const { laptopProducts } = useSelector((state) => state.customer)
    useEffect(() => {
        dispatch(fetchLaptopProducts())
    }, [])
    return (
