...
import { fetcHeadphonesProducts } from "@/app/redux/slices/customerSlice";
import Product_card from "@/app/roles/customer_system/components/Product_card";

const Page = () => {
    const dispatch = useDispatch()
    const { headphoneProducts } = useSelector((state) => state.customer)
    useEffect(() => {
        dispatch(fetcHeadphonesProducts())
    }, [])
    return (
